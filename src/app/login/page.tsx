    ...
    <div className="bg-white border border-gray-200/90 rounded-2xl p-6 sm:p-8 shadow-xs">
      ...
      {registered && (
        <div
          ...
          className="mb-6 p-4 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center gap-3 text-emerald-800 text-sm font-medium"
        >
          <svg
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <a
              href="#forgot"
              className="text-xs font-medium text-[#5B48EE] hover:text-[#4936E3] transition-colors"
            >
              Forgot password?
            </a>
          </div>
          <div className="relative">
            <input
              ...
              placeholder="••••••••"
              className="w-full rounded-xl border border-gray-200 pl-3.5 pr-11 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 bg-white transition-all focus:outline-none focus:ring-2 focus:ring-[#5B48EE] focus:border-transparent"
            />
            <button
              type="button"
        ...
        <div className="flex items-center">
          <input
            ...
            name="remember-me"
            type="checkbox"
            className="h-4 w-4 rounded border-gray-300 text-[#5B48EE] focus:ring-[#5B48EE]"
          />
  ...
  return (
    <div className="min-h-[85vh] flex flex-col justify-center items-center px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <Suspense
          fallback={
            <div className="bg-white border border-gray-200/90 rounded-2xl p-8 text-center text-sm text-gray-400">
